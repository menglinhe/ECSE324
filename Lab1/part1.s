			.text
			.global _start
_start:                      //Code to find the maximum maximum from a list of numbers with length N
			LDR R4, =RESULT		//R4 points to the result location R4=0x38
			LDR R2, [R4, #4]	//Can you do LDR R2, N ...... R2 holds the number of elements in the list R4+4 = 0x3c; R2=7
			ADD R3, R4, #8		//R3 points to the first number; R3= R4+8=0x38 + 8 = 0x40
			LDR R0, [R3]		//R0 holds the first number in the list; R0 = 4

LOOP:		SUBS R2, R2, #1 	// HELP:how does it decrement?....decrement the loop counter
